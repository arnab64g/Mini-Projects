...
namespace N4S_Player
{
    public partial class A7_Music : Form
    {
        ...
        private void Update_Bar(object? sender, EventArgs e)
        {
            ...
            {
                npl.Text = device.AudioClient.MixFormat.AverageBytesPerSecond.ToString();//"Now Playing: " + D[ci].name;
                ...
                TDuration.Visible = true;
                seek.Value = ct;
                progressBar1.Value = (int)(device.AudioMeterInformation.MasterPeakValue * 100);
