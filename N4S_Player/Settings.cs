namespace N4S_Player
{
    ...
    {
        static string path = @"C:\\Users\arnab\\Documents\\N4S\\stng.sfl";
        static string playlist = @"C:\\Users\arnab\\Documents\\N4S\\playlist.sfl";
        static void checkfile()
        {
            if (!File.Exists(path))
            {
                Directory.CreateDirectory("C:\\Users\\arnab\\Documents\\N4S");
        ...
        public static void Update_Volume(int n)
        {
